        ...
        <div className='p-5 text-center mt-5 our_team_whole '>
            ...
            <div className='text-center' style={{ marginTop: 70 }}>
                        ...
                        <div className="flip whole_flip pb-3">
                            ...
                            <div className="back" style={{}}>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                                    <div>
                                        <p className='' style={{ fontSize: '18px' }}>{item.content}</p>
                                    </div>
                                </div>
                            </div>
                ...
                <Row className='our_team_second_row'>
                    ...
                    <Col xl={4} lg={4} md={12} sm={12} xs={12} className='mb-5'>
                        <div className="flip whole_flip pb-3">
                            <div className="front" style={{ backgroundImage: `url(${fahad})` }}>
                                {/* <h1 className="text-shadow">OCEAN</h1> */}
                            </div>
                            <div className="back" style={{}}>
                                {/* <h4>Salem Ododa</h4> */}
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                                    <div>
                                        <p className='' style={{ fontSize: '18px' }}>Muhammad Fahad is a certified Near developer with over 5 years experience in software development. Muhammad Fahad worked in building tech startups related to Health Care System.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Col xl={4} lg={4} md={12} sm={12} xs={12} className='mb-5'> 
                        <div className="flip whole_flip pb-3">
                            <div className="front" style={{ backgroundImage: `url(${salem})` }}>
                                {/* <h1 className="text-shadow">OCEAN</h1> */}
                            </div>
                            <div className="back" style={{}}>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                                    <div>
                                        <p className='' style={{ fontSize: '18px' }}>I'm a backend developer and technology enthusiast in general, and I use backend technologies to create solutions to real-world problems. I also enjoy reading and writing technical articles during my leisure time.</p>
                                    </div>
                                </div>
                            </div>
