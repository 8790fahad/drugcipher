...
export default function PharmacyNavMenu() {
    ...
    return (
        <div className='pharmacy_nav_menu' style={{ positon: 'sticky', top: 0 }}>
            ...
            <Row className='m-0'>
                <Col md={3}>
                    <img src={drugcipherIcon} alt='drugcipherlogo' style={{ width: 55, marginTop: 7 }} onClick={() => navigate('/drug-cipher/market-place/')} />
                    <p className='dc_name' onClick={() => navigate('/drug-cipher/market-place/')}>Drug Cipher</p>
                </Col>
                <Col md={6} className=''>
                ...
                <Col md={3}>
                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '20px', height: '70px' }}>
                        <div className='icon_div p-1' style={{ position: 'relative' }} onClick={() => navigate('/market-place/cart')}>
