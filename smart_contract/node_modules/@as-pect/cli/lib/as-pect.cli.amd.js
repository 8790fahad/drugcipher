...
define("run", ["require", "exports", "fs", "perf_hooks", "path", "chalk", "@as-pect/core", "glob", "util/collectReporter", "util/getTestEntryFiles", "util/writeFile", "@as-pect/core/lib/util/timeDifference", "@as-pect/snapshots", "util/removeFile"], function (require, exports, fs, perf_hooks_1, path, chalk_5, core_1, glob_2, collectReporter_1, getTestEntryFiles_1, writeFile_1, timeDifference_1, snapshots_1, removeFile_1) {
    ...
    function run(cliOptions, compilerArgs) {
        ...
        console.log(chalk_5.default(templateObject_22 || (templateObject_22 = __makeTemplateObject(["{bgWhite.black [Log]} Compiler loaded in {yellow ", "ms}."], ["{bgWhite.black [Log]} Compiler loaded in {yellow ", "ms}."])), timeDifference_1.timeDifference(perf_hooks_1.performance.now(), start).toString()));
        ...
        if (compilerArgs.length > 0) {
            ...
            if (output.unknown.length > 0) {
                console.error(chalk_5.default(templateObject_26 || (templateObject_26 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold.yellow [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold.yellow [", "]}."])), output.unknown.join(", ")));
                process.exit(1);
            }
        }
        ...
        if (coverageFiles.length !== 0) {
            chalk_5.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["{bgWhite.black [Log]} Using code coverage: ", ""], ["{bgWhite.black [Log]} Using code coverage: ", ""])), coverageFiles.join(", "));
         ...
         */
        if (compilerArgs.length > 0) {
            console.log(chalk_5.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) +
                compilerArgs.join(" "));
        }
        ...
        if (testEntryFiles.size === 0) {
            console.error(chalk_5.default(templateObject_38 || (templateObject_38 = __makeTemplateObject(["{red [Error]} No files matching the pattern were found."], ["{red [Error]} No files matching the pattern were found."]))));
            process.exit(1);
        }
        try {
        ...
        if (flags["--extension"]) {
            console.log(chalk_5.default(templateObject_39 || (templateObject_39 = __makeTemplateObject(["{bgWhite.black [Log]} Changing extension for injected assembly files"], ["{bgWhite.black [Log]} Changing extension for injected assembly files"]))));
            ...
            var files = glob_2.default.sync(path.join(assemblyFolder, "**/*.ts"));
        ...
        console.log(chalk_5.default(templateObject_41 || (templateObject_41 = __makeTemplateObject(["  {green [TestFile.ts]} {yellow ", "} ", ""], ["  {green [TestFile.ts]} {yellow ", "} ", ""])), Array.from(addedTestEntryFiles).join(" "), flagList.join(" ")));
        ...
        function runBinary(error, file, binary) {
            ...
            if (runTests) {
                ...
                if (typeof configurationImports === "function") {
                    ...
                    if (!result) {
                        console.error(chalk_5.default(templateObject_44 || (templateObject_44 = __makeTemplateObject(["{red [Error]} Imports configuration function did not return an AssemblyScript module. (Did you forget to return it?)"], ["{red [Error]} Imports configuration function did not return an AssemblyScript module. (Did you forget to return it?)"]))));
                        process.exit(1);
                    }
                }
                else {
            ...
            if (count === 0) {
                if (runTests) {
                    ...
                    var result = failed ? chalk_5.default(templateObject_45 || (templateObject_45 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_5.default(templateObject_46 || (templateObject_46 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                    try {
...
define("types", ["require", "exports", "chalk", "fs", "path"], function (require, exports, chalk_6, fs_5, path_3) {
    ...
    function types() {
        ...
        console.log("");
        console.log(chalk_6.default(templateObject_49 || (templateObject_49 = __makeTemplateObject(["{bgWhite.black [Log]} Initializing types."], ["{bgWhite.black [Log]} Initializing types."]))));
        console.log("");
        // Create the assembly folder if it doesn't exist
        if (!fs_5.existsSync(assemblyFolder)) {
            console.log(chalk_6.default(templateObject_50 || (templateObject_50 = __makeTemplateObject(["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/}"], ["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/}"]))));
            fs_5.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_5.existsSync(testFolder)) {
            console.log(chalk_6.default(templateObject_51 || (templateObject_51 = __makeTemplateObject(["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/__tests__/}"], ["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/__tests__/}"]))));
            fs_5.mkdirSync(testFolder);
        }
        // Always create the types file
        console.log(chalk_6.default(templateObject_52 || (templateObject_52 = __makeTemplateObject(["{bgWhite.black [Log]} Creating file: {yellow ./assembly/__tests__/as-pect.d.ts}"], ["{bgWhite.black [Log]} Creating file: {yellow ./assembly/__tests__/as-pect.d.ts}"]))));
        fs_5.createReadStream(typesFileSource, "utf-8").pipe(fs_5.createWriteStream(typesFile, "utf-8"));
    }
    exports.types = types;
    var templateObject_49, templateObject_50, templateObject_51, templateObject_52;
});
define("util/asciiArt", ["require", "exports", "chalk"], function (require, exports, chalk_7) {
    ...
    function printAsciiArt(version) {
        console.log(chalk_7.default(templateObject_53 || (templateObject_53 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\___/\\___/\\__/     \n                    /_/                        }\n\n\u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.bold.black [", "]}\n"], ["{bold.bgWhite.black ", "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/     \n                    /_/                        }\n\n\u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.bold.black [", "]}\n"])), "", version));
    }
    exports.printAsciiArt = printAsciiArt;
    var templateObject_53;
});
