...
class u128 extends U128 {
  ...
  @inline
  static fromBytesLE(array: Array<u8>): u128 {
    return changetype<u128>(U128.fromBytesLE(array));
  }
  @inline
  static fromBytesBE(array: Array<u8>): u128 {
...
else if (value instanceof Array<u8>) return u128.fromBytes(<Array<u8>>value);
...
;
    return changetype<u128>(U128.sub(changetype<U128>(a), changetype<U128>(b)));
  }
  @operator("*")
  static mul(a: u128, b: u128): u128 {
    ...
    return changetype<u128>(U128.mul(changetype<U128>(a), changetype<U128>(b)));
  }
  @inline
  @operator("/")
...
else if (dummy instanceof Array<u8>) return <T>this.toBytes();
  ...
  public __asonPut<U>(ser: U, entryId: u32, fields: Array<u32> = []): void {
    if (isDefined(super.__asonPut)) super.__asonPut(ser, entryId, [] as Array<u32>.concat(fields));
;
  }

  decode<_V = Uint8Array>(buf: _V): u128 {
    let json: JSON.Obj;
  ...
  static decode(buf: Uint8Array): u128 {
    return decode<u128>(buf);
  }

  private _decode(obj: JSON.Obj): u128 {
